...
- Optional cloud embedding providers (`openai`, `google`, `minimax`, `orcarouter`, `voyage`) send embedded source snippets to the configured provider only when explicitly selected
